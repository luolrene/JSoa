  ...
  <div>
    <el-container class="container-main">
      ...
      <el-aside width="250px" class="main-right">
        ...
        <draggable :list="CommonUserComponents" v-bind="{
            group: {
              name: 'people',
              pull: 'clone',
              put: false,
...
import { getCustomerFormModify } from '@/api/integrated/form.js'
...
export default {
  ...
  methods: {
    ...
    submitForm() {
      ...
      this.fromValiData.dataBlock = JSON.stringify(this.configFormData)
      getCustomerFormModify(this.fromValiData)
        .then(res => {
          this.dialogVisible = false
          this.clearWidetConfit()
  ...
  created() {
    this.jsonmsg = this.code.dataBlock
    this.configFormData = this.code.dataBlock
    this.fromValiData = this.code
    this.setJsonBtn()
  }
}
</script>
