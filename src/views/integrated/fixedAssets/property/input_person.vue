...
export default {
  ...
  methods: {
    ...
    doConfirm() {
      ...
      // 负责人
      this.$parent.fromValiData.operationUserIdAll = selectPerson.userId
      this.$parent.fromValiData.operationUserNameAll = selectPerson.userName
      this.$parent.userData = this.multipleSelection
      this.$layer.close(this.layerid)
    }
  },
  mounted() {
    this.fromValiData.groupId = this.groupIdAll
    if (this.userData) {
