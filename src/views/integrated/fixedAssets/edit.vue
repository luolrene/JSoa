...
export default {
  ...
  data() {
    return {
      ...
      fromItemList: [
        { label: '上级流程', prop: 'fatherName', value: '', type: 'input', disabled: true },
        { label: '流程名称', prop: 'name', value: '', type: 'input', isRqd: true },
        { label: '是否启用', prop: 'state', value: '', type: 'select', data: [{ name: '启用', id: '1' }, { name: '停用', id: '2' }], isRqd: true },
        { label: '自定义表单', prop: 'customerFormId', value: '', type: 'select', data: [], isRqd: true },
        { label: '条件', prop: 'condition', value: '', type: 'input', isRqd: false },
