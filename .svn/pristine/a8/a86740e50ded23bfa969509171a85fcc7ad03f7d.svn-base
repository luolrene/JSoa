...
export default {
  ...
  methods: {
    ...
    doConfirm() {
      ...
      this.$parent.fromValiData.assetsUserIdAll = selectPerson.userId
      this.$parent.fromValiData.assetsUserNameAll = selectPerson.userName
      this.$parent.userData = this.multipleSelection
      this.$layer.close(this.layerid)
    }
  },
  mounted() {
    this.fromValiData.groupId = this.groupId
    if (this.userData) {
