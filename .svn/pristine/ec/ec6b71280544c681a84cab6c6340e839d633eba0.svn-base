<template>
  <div class="operate-container">
    <el-form ref="fromValiData" :model="fromValiData" :rules="rules" label-width="130px" label-position="right" disabled>
      ...
      <el-row>
        ...
        <el-col :span="8">
          <el-form-item label="部门:" prop="groupId">
            <el-cascader v-model="fromValiData.groupId" :options="groupData" placeholder="请选择部门" :props="{ checkStrictly: true }" ref="myCascader" clearable></el-cascader>
          </el-form-item>
        </el-col>
        <el-col :span="8">
          <el-form-item label="角色:" prop="role">
            <el-select v-model="fromValiData.role" placeholder="请选择角色" multiple @change="roleLabel">
      ...
      <el-row>
        <el-col :span="8">
          <el-form-item label="行政职级:" prop="administrativeRank">
            <el-select v-model="fromValiData.administrativeRankName" placeholder="请选择行政职级" @change="currentSel">
        ...
        <el-col :span="8">
          <el-form-item label="技术职级:" prop="technicalRank">
            <el-select v-model="fromValiData.technicalRankName" placeholder="请选择技术职级" @change="currentRank">
        ...
        <el-col :span="8">
          <el-form-item label="市场职级:" prop="marketRank">
            <el-select v-model="fromValiData.marketRankName" placeholder="请选择市场职级" @change="currentMarklet">
      ...
      <el-row>
        ...
        <el-col :span="8">
          <el-form-item label="户口所在地:" prop="registeredResidence">
            <el-cascader v-model="fromValiData.registeredResidence" :options="nativePlaceData" clearable></el-cascader>
          </el-form-item>
        </el-col>
      </el-row>
      ...
      <el-row>
        ...
        <el-col :span="8">
          <el-form-item label="户口地址:" prop="maritalStatusAddress">
            <el-input v-model="fromValiData.maritalStatusAddress" placeholder="请输入户口地址" />
          </el-form-item>
        </el-col>
        <el-col :span="8">
          <el-form-item label="通信地址:" prop="mailingAddress">
            <el-input v-model="fromValiData.mailingAddress" placeholder="请输入通信地址" />
          </el-form-item>
        </el-col>
      </el-row>
      ...
      <el-row>
        ...
        <el-col :span="8">
          <el-form-item label="银行账号(银行):" prop="bankCode">
            <el-input v-model="fromValiData.bankCode" placeholder="请输入银行账号" />
          </el-form-item>
        </el-col>
    ...
    <!-- <div class="operate-button">
      <el-button class="cancel-btn" @click='$layer.close()'>取消</el-button>
...
export default {
  data() {
    return {
      ...
      rules: {
        ...
        // workingYear: [
        //   { required: true, message: '请输入原工作工作年限', trigger: 'blur' },
        ...
        idNumber: [
          ...
          { validator: idNumber, trigger: 'change' }
        ],
        contactAddress: [
        ...
        identification: [
          { required: true, message: '请选择签订标识', trigger: 'blur' }
        ],
        years: [
          { required: true, message: '请输入签订年限', trigger: 'blur' },
          { validator: validateNumber, trigger: 'change' }
        ],
        contractStartTime: [
  ...
  methods: {
    currentSel(value) {
      let obj = {}
      obj = this.administrativeRankData.find(item => {
        return (item = item.name)
      })
      this.fromValiData.administrativeRankName = obj.name
      this.fromValiData.administrativeRank = obj.id
    },
    currentRank(value) {
      let xdd = {}
      xdd = this.technicalRankData.find(item => {
        return (item = item.name)
      })
      this.fromValiData.technicalRankName = xdd.name
      this.fromValiData.technicalRank = xdd.id
    },
    currentMarklet(value) {
      let cmy = {}
      cmy = this.marketRankData.find(item => {
        return (item = item.name)
      })
      this.fromValiData.marketRankName = cmy.name
      this.fromValiData.marketRank = cmy.id
    },
    roleLabel(value) {
      let arr = []
  ...
  mounted() {
    this.params = this.$store.getters.userInfo
    if (this.params) {
      this.fromValiData = this.params
      // this.fromValiData.nativePlace = this.params.nativePlace.split(',')
      // this.fromValiData.registeredResidence = this.params.registeredResidence.split(
      //   ','
      // )
      // this.fromValiData.groupId = this.params.groupId.split(',')
