...
export default {
  ...
  methods: {
    ...
    doConfirm() {
      ...
      if (this.type === 'principal') {
        // 负责人
        this.$parent.fromValiData.responsibilityUserId = selectPerson.userId
        this.$parent.fromValiData.responsibilityUserName = selectPerson.userName
        this.$parent.responsibilityUser = this.multipleSelection
      } else if (this.type === 'participant') {
        // 参与人
        this.$parent.fromValiData.participateInUserId = selectPerson.userId
        this.$parent.fromValiData.participateInUserName = selectPerson.userName
        this.$parent.participateInUser = this.multipleSelection
      } else {
        this.$parent.fromValiData.noticeUserId = selectPerson.userId
        this.$parent.fromValiData.noticeUserName = selectPerson.userName
        this.$parent.noticeUser = this.multipleSelection
      }
  ...
  mounted() {
    ...
    if (this.groupIdAll) {
      this.fromValiData.groupId = this.groupIdAll[0]
    }
    this.getListData()
    this.getGroup()
  },
