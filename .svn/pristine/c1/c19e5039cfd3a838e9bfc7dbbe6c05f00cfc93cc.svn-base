<template>
  <div class="operate-container">
    <fromItem :obj="this" :layerid="layerid" :fromItemList="fromItemList" :fromValiData="fromValiData" :disabled="disabled" :btnLoading="btnLoading" :rules="rules">
    </fromItem>
  </div>
</template>
...
export default {
  ...
  created() {
    if (Number(this.$store.getters.userInfo.level) > 3) {
      this.disabled = false
    }
  }
}
